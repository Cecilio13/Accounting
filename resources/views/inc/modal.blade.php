                ...
                if('{{$VV->voucher_link_id}}'==bill_id){
                    ...
                    @foreach($VoucherJournalEntry as $VJE)
                        if('{{$VJE->voucher_ref_no}}'=='{{$VV->voucher_no}}'){
                            ...
                            markup=markup+'<td style="vertical-align:middle;"><select type="text"  disabled class="form-control" id="accounttittle'+columncountjournaentry+'" ><option></option>@foreach($COA as $coa)<option title="{{$coa->coa_account_type}}" value="{{$coa->id}}">{{$coa->coa_name}}</option>@endforeach</select></td>';
                                            ...
                                            <script>
                                                ...
                                                function addcolumnJournalEntry(){
                                                    ...
                                                    var markup = '<tr id="transactiontrj'+columncountjournaentry+'">';
                                                        ...
                                                        markup=markup+'<td style="vertical-align:middle;"><select type="text"  class="form-control" id="accounttittle'+columncountjournaentry+'" ><option></option>@foreach($COA as $coa)<option title="{{$coa->coa_account_type}}" value="{{$coa->id}}">{{$coa->coa_name}}</option>@endforeach</select></td>';
                ...
                <div class="col-md-12 p-0 mb-4">
                    ...
                    <div class="my-3 p-0 mb-4">
                        <div class="col-md-4 p-0 pr-3  mb-4">
                            ...
                            <option value="">--Select Name--</option>
                            @foreach($customers as $customer)
                                <option value="{{$customer->customer_id}}">{{$customer->display_name!=""? $customer->display_name : $customer->f_name." ".$customer->l_name}}</option>
                            @endforeach
                            </select>
                        </div>
                ...
                <div class="col-md-12 p-0 mb-4">
                    <div class="my-3 p-0">
                        <div class="col-md-3 p-0 pr-3">
                            ...
                            <option value="">--Select Name--</option>
                            @foreach($customers as $customer)
                                    <option title="{{$customer->account_type}}" value="{{$customer->customer_id}}">{{$customer->display_name!=""? $customer->display_name : $customer->f_name." ".$customer->l_name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-3 p-0 pr-3" >
                    ...
                    <div class="my-3 p-0">
                        <div class="col-md-3 p-0 pr-3">
                            ...
                            <select  name="sc_customer"  id="sc_customer" class="w-100 selectpicker" data-live-search="true">
                                    ...
                                    @foreach($customers as $customer)
                                    <option value="{{$customer->customer_id}}">{{($customer->display_name!=""? $customer->display_name : ($customer->company_name!=""? $customer->company_name: $customer->f_name." ".$customer->l_name))}}</option>
                                    @endforeach
                                    </select>
                        </div>
                        <div class="col-md-2 p-0 pr-3" style="{{!empty($numbering) && $numbering->use_cost_center=="Off"? 'display:none;' : ''}}">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-md-6 p-1">
                    ...
                    <div class="mb-3">
                        <p>Account Type</p>
                        <select id="coaAccountType" name="ACCType" class="w-100 pt-1" onchange="ChangeDetailType()">
                            <option>Bank</option>
                        ...
                        <br><br>
                        <input type="text" class="w-100" name="customaccounttype" style="display:none;" id="customaccount"> 
                    </div>
                    <script>
                    ...
                    <textarea rows="7" id="TypeDescriptionTextArea" class="w-100 mt-3" readonly>Use a Cash on hand account to track cash your company keeps for occasional expenses, also called petty cash.\nTo track cash from sales that have not been deposited yet, use a pre-created account called Undeposited funds, instead.</textarea>
                </div>
                <div class="col-md-6 p-1">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="coatitle" list="account_title_datalist" type="text" name="coatitle"  class="w-100">
                                <option>Assets</option>
                                <option>Liabilities</option>
                                <option>Equity</option>
                                <option>Revenues</option>
                                <option>Expenses</option>
                                <option>Intermidiate Accounts</option>
                            </select>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $("#add_lines_expense_account").click(function(event){
            event.preventDefault();
            var markup = '<tr class="expense_lines_account" id="expense_line_account'+$('#expense_account_table tr').length+'"><td class="pt-3-half" id="number_tag_expense_account" contenteditable="false">'+$('#expense_account_table tr').length+'</td><td class="pt-3-half"><select style="border:0; width:100%;" list="account_expenses" class="expense_data account_select_expense" id="select_account_expense'+$('#expense_account_table tr').length+'"><option></option>@foreach($COA as $coa)<option value="{{$coa->id}}">{{$coa->coa_name}}</option>@endforeach</select></td><td class="pt-3-half"><input class="expense_data description_select_expense" id="select_description_expense'+$('#expense_account_table tr').length+'" style="border:0;"></td><td class="pt-3-half"><input type="number" class="expense_data amount_select_expense" onclick="this.select();" id="select_expense_amount'+$('#expense_account_table tr').length+'" style="border:0; text-align:center;"></td><td class="pt-3-half"><a href="#" id="delete_account_expense'+$('#expense_account_table tr').length+'" class="fa fa-trash delete_account_expense"></a></td></tr>';
