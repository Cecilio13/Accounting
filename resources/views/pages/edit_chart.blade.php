...
<div class="container" >
        ...
        <div class="col-md-6 p-1">
            ...
            <div class="mb-3">
                <p>Account Type</p>
                <select id="coaAccountType2" name="ACCType2" class="w-100 pt-1" onchange="ChangeDetailType2()">
                    <option>Bank</option>
                ...
                <br><br>
                <input type="text" class="w-100" style="display:none;" name="customaccounttype2"  id="customaccount2"> 
            ...
            <textarea rows="7" id="TypeDescriptionTextArea2" class="w-100 mt-3" readonly>Use a Cash on hand account to track cash your company keeps for occasional expenses, also called petty cash.\nTo track cash from sales that have not been deposited yet, use a pre-created account called Undeposited funds, instead.</textarea>
        </div>
        <div class="col-md-6 p-1">
            ...
            <div class="mb-3">
                <p>Description</p>
                <input id="coaDesc2" type="text" name="COADesc2" value="{{$chart->coa_description}}" class="w-100">
            </div>
            <div class="mb-3">
                <p>Code</p>
            ...
            <div class="mb-3">
                    ...
                    <select id="coatitl2e"   type="text" name="coatitl2e"  class="w-100">
